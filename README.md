# kg-houses
Real Estate for KG-Core Framework :house_with_garden:
...
- [kg-radialmenu](https://github.com/kgcore-framework/kg-radialmenu) - For the menu in screenshots
- [kg-anticheat](https://github.com/kgcore-framework/kg-anticheat) - Anti Cheat 
- [kg-phone](https://github.com/kgcore-framework/kg-phone) - Houses app
- [kg-multicharacter](https://github.com/kgcore-framework/kg-multicharacter) - Checking if player is inside after character chosen (You need to edit the lines if you don't use this)
- [kg-garages](https://github.com/kgcore-framework/kg-garages) - House Garage
- [kg-interior](https://github.com/kgcore-framework/kg-interior) - Necessary for house interiors
- [kg-clothing](https://github.com/kgcore-framework/kg-clothing) - Outfits
- [kg-weathersync](https://github.com/kgcore-framework/kg-weathersync) - Desync weather inside house
- [kg-weed](https://github.com/kgcore-framework/kg-weed) - Weed plant
- [kg-minigames](https://github.com/kgcore-framework/kg-minigames) - Skills
...
- Import `kg-houses.sql` in your database
- Add the following code to your server.cfg/resouces.cfg
```
ensure kg-core
ensure kg-radialmenu
ensure kg-anticheat
ensure kg-phone
